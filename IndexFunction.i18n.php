...
$messages['be-tarask'] = array(
	...
	'indexfunc-editwarning' => 'Папярэджаньне: Гэтая назва зьяўляецца індэкснай для {{PLURAL:$2|1=наступнай старонкі|наступных старонак}}: $1
Упэўніцеся, што старонка, якую Вы зьбіраецеся стварыць, яшчэ не існуе зь іншай назвай.
Калі Вы створыце гэту старонку, выдаліце гэту назву з <nowiki>{{#index:}}</nowiki> у {{PLURAL:$2|1=наступнай старонцы|наступных старонках}}.', # Fuzzy
	'indexfunc-index-exists' => 'Старонка «$1» ужо існуе',
	'indexfunc-movewarn' => 'Папярэджаньне: «$1» зьяўляецца індэкснай назвай для {{PLURAL:$3|1=наступнай старонкі|наступных старонак}}: $2
Калі ласка, выдаліце «$1» з <nowiki>{{#index:}}</nowiki> у {{PLURAL:$3|1=наступнай старонцы|наступных старонках}}.', # Fuzzy
	'index' => 'Індэкс',
 ...
 */
$messages['fa'] = array(
	'indexfunc-desc' => 'عملیات تجزیه برای ایجاد تغییر جهت‌های خودکار و ابهام‌زدایی صفحات',
	'indexfunc-badtitle' => 'عنوان نامعتبر: «$1»',
	'indexfunc-editwarning' => 'هشدار: 
این عنوان یک عنوان شاخص برای {{PLURAL:$2|صفحه|صفحات}} زیر است:
$1
مطمئن باشید صفحه‌ای که شما در حال ایجاد کردن هستید، در حال حاضز تحت عنوان دیگری وجود نداشته باشد.
اگر این صفحه را ایجاد می‌کنید، این عنوان را از <nowiki>{{#index:}}</nowiki> در بالای {{PLURAL:$2|page|pages}} حذف کنید.',
	'indexfunc-index-exists' => 'صفحهٔ "$1" در حال حاضر وجود دارد',
	'indexfunc-movewarn' => 'هشدار:
"$1" یک عنوان شاخص برای {{PLURAL:$3|page|pages}} زیر است:
$2
لطفاً‌ "$1" را از <nowiki>{{#index:}}</nowiki> در بالای {{PLURAL:$3|page|pages}} حذف کنید.',
	'index' => 'جستجوی شاخص',
	...
	'index-search-explain' => 'این صفحه از یک جستجوی پیشوند استفاده می‌کند.
اولین مشخصه‌های کم را تایپ کنید و دکمهٔ تأیید را برای جستجوی عناوین صفحات فشار دهید و ورودی‌هایی که با مجموعهٔ جستجو شروع می‌شوند را فهرست کنید',
	'index-details-explain' => 'ورودی‌های فلش‌دار، ورودی‌های فهرست شده هستند.
فلش را برای نشان دادن همهٔ صفحات فهرست شده تحت آن عنوان کلیک کنید.',
);
...
Nemm op dä {{PLURAL:$3|Sigg|Sigge|Fähler}} dat „$1“ uß däm <nowiki>{{#index:}}</nowiki> eruß!',
	'index' => 'index',
	'index-legend' => 'Donn en de automatesche Ömleidonge un „Watt-ėßß-datt?“-Leßte söhke',
...
Стиснете на стрелката за да ги видите сите страници индексирани под тој наслов.',
);
...
$messages['ru'] = array(
	...
	'indexfunc-editwarning' => 'Предупреждение. Это название является индексным для {{PLURAL:$2|1=следующей страницы|следующих страниц}}:
$1
Убедитесь, что страница, которую вы собираетесь создать, не существует под другим названием.
Если вы создаёте эту страницу, удалите это название из <nowiki>{{#index:}}</nowiki> на {{PLURAL:$2|1=вышеуказанной странице|вышеуказанных страницах}}.',
	'indexfunc-index-exists' => 'Страница «[[$1]]» уже существует',
	'indexfunc-movewarn' => 'Предупреждение. «$1» является индексным названием для {{PLURAL:$3|1=следующей страницы|следующих страниц}}:
$2
Пожалуйста, удалите «$1» из <nowiki>{{#index:}}</nowiki> на {{PLURAL:$2|1=вышеуказанной странице|вышеуказанных страницах}}.',
	'index' => 'Индекс',
...
$messages['uk'] = array(
	...
	'indexfunc-editwarning' => 'Попередження. Ця назва є індексною для {{PLURAL:$2|1=наступної сторінки|наступних сторінок}}:
$1
Переконайтеся, що сторінка, яку ви збираєтеся створити, не існує під іншою назвою.
Якщо ви створюєте цю сторінку, вилучіть назву <nowiki>{{#index:}}</nowiki> {{PLURAL:$2|1=зазначеної вище сторінці|зазначених вище сторінок}}.',
	'indexfunc-index-exists' => 'Сторінка "$1" вже існує',
	'indexfunc-movewarn' => 'Попередження. „$1“ є індексною назвою для {{PLURAL:$3|1=наступної сторінки|наступних сторінок}}:
$2
Будь ласка, вилучіть „$1“ <nowiki>{{#index:}}</nowiki> {{PLURAL:$2|1=зазначеної вище сторінці|зазначених вище сторінок}}.',
