...
Если вы создаёте эту страницу, удалите это название из <nowiki>{{#index:}}</nowiki> на {{PLURAL:$2|1=указанной выше странице|указанных выше страницах}}.', # Fuzzy
...
$2
Пожалуйста, удалите «$1» из <nowiki>{{#index:}}</nowiki> на {{PLURAL:$2|1=указанной выше странице|указанных выше страницах}}.', # Fuzzy
	'index' => 'Индекс',
